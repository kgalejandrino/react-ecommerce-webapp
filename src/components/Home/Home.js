...
const Home = () => {
  ...
  return (
    <Fragment>
      <section className={classes["section-hero--img"]}>
        <div className="row">
      ...
      <section className={classes["section-info"]}>
        <div className={`${classes["section-flex"]} row`}>
      ...
      <section className={classes["section-services"]}>
        <div className="row">
          ...
          <p className={classes["services-text"]}>
            ...
            configuration, data recovery and many more. Not sure why your
            computer is lagging or running slow? Let’s take care of that and get
            you ready to play at high level.
          </p>
          <div className={classes["card-services"]}>
            ...
            <li>
              ...
              <p>
                ...
                requirements. We can guarantee you that our pc meets high
                standard quality and is put thru a series of test to perform at
                peak level.
              </p>
            </li>
            <li>
