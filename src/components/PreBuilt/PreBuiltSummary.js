...
const PreBuiltSummary = () => {
  return (
    <div className={classes.banner}>
      <div className={`${classes["banner-flex"]} row`}>
        ...
        <div className={classes["banner-textbox"]}>
          ...
          <p>
            A variety of pre-built pc, built in perfection. Choose from our
            broad selection of ready to shipped pc that varies in component
            selection and price depending on your needs and preference.
          </p>
